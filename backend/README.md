...
## Project Structure
    ...
    ├── testnewuserapp_dev_32623  # Django project configurations
...
1. Clone this repo and `cd testnewuserapp_dev_32623`
...
2. Clone this repo and `cd testnewuserapp_dev_32623`
